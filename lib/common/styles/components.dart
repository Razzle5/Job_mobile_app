      ...
      child: Material(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isOutlined ? Colors.white : CColors.kTextColor,
            border: Border.all(color: CColors.kTextColor, width: 2.5),
            borderRadius: BorderRadius.circular(30),
          ),
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                ...
                fontSize: 20,
                color: isOutlined ? CColors.kTextColor : Colors.white,
              ),
            ),
          ),
        ),
