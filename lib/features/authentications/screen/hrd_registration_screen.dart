...
// HAPUS IMPORTS YANG HILANG/RUSAK:
                  ...
                  child: SingleChildScrollView(
                    child: Column( 
                      ...
                      children: [
                        ...
                        const Center(child: Text('HRD Sign Up', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.blueAccent))),
                        ...
                        TextFormField(
                          ...
                          validator: (value) => (value != controller.password.text) ? 'Password tidak cocok.' : null,
                          decoration: const InputDecoration(hintText: 'Confirm Password', border: OutlineInputBorder()),
                        ),
                        ...
                        // 8. Tombol Login 
                        TextButton(
                            onPressed: () => Navigator.pushNamed(context, HrdLoginScreen.id),
